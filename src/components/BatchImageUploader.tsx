...
import { UploadResult, UploadResponse } from '../types';
    ...
    <div className="w-full max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Upload images to create live video streams with Daydream AI
        </p>
      </div>
              ...
              <div key={index} className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                ...
                {result.error ? (
                  ...
                  <div className="space-y-4 p-4">
                    {result.hls_url && (
                      <div>
                        <h4 className="text-sm font-medium text-gray-700 mb-2">HLS Stream</h4>
                        <VideoPlayer
